...
const team = [
  {
    ...
    img: "/team/Ancy_mam.jpeg",
  },
  {
    name: "Ayoona Maria John",
    role: "Chairperson",
    phone: "8075412292",
    email: "ayoonamariajohn@ieee.org",
  ...
  },
  {
    ...
    role: "Vice-Chair",
    phone: "9778422456",
    email: "meenakshisanthosh@ieee.org",
  ...
  return (
    <section id="team" className="relative py-24 bg-background">
      ...
      <div className="container mx-auto px-6">
        ...
        {/* Faculty Coordinator - Single Box */}
